...
export const ConfigureHandlersResponse: MessageFns<ConfigureHandlersResponse> = {
  encode(message: ConfigureHandlersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.contractConfigs) {
      ContractConfig.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.accountConfigs) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ConfigureHandlersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ContractConfig: MessageFns<ContractConfig> = {
  encode(message: ContractConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.fuelCallConfigs) {
      FuelCallHandlerConfig.encode(v!, writer.uint32(106).fork()).join();
    }
    ...
    for (const v of message.fuelLogConfigs) {
      FuelLogHandlerConfig.encode(v!, writer.uint32(122).fork()).join();
    }
  ...
  fromJSON(object: any): ContractConfig {
    return {
      ...
      fuelCallConfigs: globalThis.Array.isArray(object?.fuelCallConfigs)
        ...
        : globalThis.Array.isArray(object?.fuel_call_configs)
        ? object.fuel_call_configs.map((e: any) => FuelCallHandlerConfig.fromJSON(e))
        : [],
      ...
      fuelLogConfigs: globalThis.Array.isArray(object?.fuelLogConfigs)
        ...
        : globalThis.Array.isArray(object?.fuel_log_configs)
        ? object.fuel_log_configs.map((e: any) => FuelLogHandlerConfig.fromJSON(e))
        : [],
...
export const TotalPerEntityAggregation: MessageFns<TotalPerEntityAggregation> = {
  encode(_: TotalPerEntityAggregation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TotalPerEntityAggregation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RetentionConfig {
    return {
      retentionEventName: isSet(object.retentionEventName)
        ? globalThis.String(object.retentionEventName)
        : isSet(object.retention_event_name)
        ? globalThis.String(object.retention_event_name)
        : "",
...
export const AccountConfig: MessageFns<AccountConfig> = {
  encode(message: AccountConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.aptosIntervalConfigs) {
      AptosOnIntervalConfig.encode(v!, writer.uint32(42).fork()).join();
    }
    for (const v of message.moveIntervalConfigs) {
  ...
  fromJSON(object: any): AccountConfig {
    return {
      ...
      aptosIntervalConfigs: globalThis.Array.isArray(object?.aptosIntervalConfigs)
        ...
        : globalThis.Array.isArray(object?.aptos_interval_configs)
        ? object.aptos_interval_configs.map((e: any) => AptosOnIntervalConfig.fromJSON(e))
        : [],
      moveIntervalConfigs: globalThis.Array.isArray(object?.moveIntervalConfigs)
        ? object.moveIntervalConfigs.map((e: any) => MoveOnIntervalConfig.fromJSON(e))
        : globalThis.Array.isArray(object?.move_interval_configs)
...
export const AptosOnIntervalConfig: MessageFns<AptosOnIntervalConfig> = {
  encode(message: AptosOnIntervalConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AptosOnIntervalConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlockHandlerConfig: MessageFns<BlockHandlerConfig> = {
  encode(message: BlockHandlerConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.handlerId !== 0) {
      writer.uint32(8).int32(message.handlerId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlockHandlerConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const FuelLogHandlerConfig: MessageFns<FuelLogHandlerConfig> = {
  encode(message: FuelLogHandlerConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FuelLogHandlerConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const FuelCallFilter: MessageFns<FuelCallFilter> = {
  encode(message: FuelCallFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.function !== "") {
      writer.uint32(10).string(message.function);
    }
    if (message.includeFailed !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FuelCallFilter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const FuelCallHandlerConfig: MessageFns<FuelCallHandlerConfig> = {
  encode(message: FuelCallHandlerConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.filters) {
      FuelCallFilter.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.handlerId !== 0) {
      writer.uint32(16).int32(message.handlerId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FuelCallHandlerConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Data: MessageFns<Data> = {
  encode(message: Data, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.fuelCall !== undefined) {
      Data_FuelCall.encode(message.fuelCall, writer.uint32(114).fork()).join();
    }
  ...
  fromJSON(object: any): Data {
    return {
      ...
      fuelLog: isSet(object.fuelLog)
        ...
        : undefined,
      fuelCall: isSet(object.fuelCall)
        ? Data_FuelCall.fromJSON(object.fuelCall)
        : isSet(object.fuel_call)
        ? Data_FuelCall.fromJSON(object.fuel_call)
        : undefined,
...
export const Data_EthLog: MessageFns<Data_EthLog> = {
  encode(message: Data_EthLog, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.log !== undefined) {
      Struct.encode(Struct.wrap(message.log), writer.uint32(26).fork()).join();
    }
    ...
    if (message.transactionReceipt !== undefined) {
      Struct.encode(Struct.wrap(message.transactionReceipt), writer.uint32(42).fork()).join();
    }
    if (message.block !== undefined) {
      Struct.encode(Struct.wrap(message.block), writer.uint32(50).fork()).join();
    }
    if (message.rawLog !== "") {
  ...
  fromJSON(object: any): Data_EthLog {
    return {
      ...
      transactionReceipt: isObject(object.transactionReceipt)
        ? object.transactionReceipt
        : isObject(object.transaction_receipt)
        ? object.transaction_receipt
        : undefined,
...
export const Data_EthBlock: MessageFns<Data_EthBlock> = {
  encode(message: Data_EthBlock, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.block !== undefined) {
      Struct.encode(Struct.wrap(message.block), writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const Data_EthTransaction: MessageFns<Data_EthTransaction> = {
  encode(message: Data_EthTransaction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.transaction !== undefined) {
      Struct.encode(Struct.wrap(message.transaction), writer.uint32(34).fork()).join();
    }
    if (message.timestamp !== undefined) {
      Timestamp.encode(toTimestamp(message.timestamp), writer.uint32(42).fork()).join();
    }
    if (message.transactionReceipt !== undefined) {
      Struct.encode(Struct.wrap(message.transactionReceipt), writer.uint32(26).fork()).join();
    }
    if (message.block !== undefined) {
      Struct.encode(Struct.wrap(message.block), writer.uint32(50).fork()).join();
    }
    if (message.trace !== undefined) {
      Struct.encode(Struct.wrap(message.trace), writer.uint32(58).fork()).join();
    }
...
export const Data_EthTrace: MessageFns<Data_EthTrace> = {
  encode(message: Data_EthTrace, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.trace !== undefined) {
      Struct.encode(Struct.wrap(message.trace), writer.uint32(34).fork()).join();
    }
    if (message.timestamp !== undefined) {
      Timestamp.encode(toTimestamp(message.timestamp), writer.uint32(42).fork()).join();
    }
...
function createBaseData_AptResource(): Data_AptResource {
  return { resources: [], version: 0n, timestampMicros: 0n, rawResources: [] };
}
...
function createBaseData_SuiEvent(): Data_SuiEvent {
  return { transaction: undefined, rawEvent: "", rawTransaction: "", timestamp: undefined, slot: 0n };
}
...
function createBaseData_SuiCall(): Data_SuiCall {
  return { transaction: undefined, rawTransaction: "", timestamp: undefined, slot: 0n };
}
...
export const Data_SuiObject: MessageFns<Data_SuiObject> = {
  encode(message: Data_SuiObject, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.self !== undefined) {
      Struct.encode(Struct.wrap(message.self), writer.uint32(34).fork()).join();
    }
...
function createBaseData_SuiObjectChange(): Data_SuiObjectChange {
  return { changes: [], rawChanges: [], timestamp: undefined, txDigest: "", slot: 0n };
}
...
export const Data_FuelCall: MessageFns<Data_FuelCall> = {
  encode(message: Data_FuelCall, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.transaction !== undefined) {
      Struct.encode(Struct.wrap(message.transaction), writer.uint32(10).fork()).join();
    }
    if (message.timestamp !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Data_FuelCall {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
