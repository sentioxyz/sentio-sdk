...
export const UsageTracker: MessageFns<UsageTracker> = {
  encode(message: UsageTracker, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.apiSku !== "") {
    ...
    if (message.customSkus !== undefined) {
      UsageTracker_CustomSkus.encode(message.customSkus, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UsageTracker {
  ...
  fromJSON(object: any): UsageTracker {
    return {
      apiSku: isSet(object.apiSku)
        ? globalThis.String(object.apiSku)
        : isSet(object.api_sku)
        ? globalThis.String(object.api_sku)
        : "",
      webuiSku: isSet(object.webuiSku)
        ? globalThis.String(object.webuiSku)
        : isSet(object.webui_sku)
        ? globalThis.String(object.webui_sku)
        : "",
      projectIdField: isSet(object.projectIdField)
        ? globalThis.String(object.projectIdField)
        : isSet(object.project_id_field)
        ? globalThis.String(object.project_id_field)
        : "",
      projectSlugField: isSet(object.projectSlugField)
        ? globalThis.String(object.projectSlugField)
        : isSet(object.project_slug_field)
        ? globalThis.String(object.project_slug_field)
        : "",
      projectOwnerField: isSet(object.projectOwnerField)
        ? globalThis.String(object.projectOwnerField)
        : isSet(object.project_owner_field)
        ? globalThis.String(object.project_owner_field)
        : "",
      versionField: isSet(object.versionField)
        ? globalThis.String(object.versionField)
        : isSet(object.version_field)
        ? globalThis.String(object.version_field)
        : "",
      customSkus: isSet(object.customSkus)
        ? UsageTracker_CustomSkus.fromJSON(object.customSkus)
        : isSet(object.custom_skus)
        ? UsageTracker_CustomSkus.fromJSON(object.custom_skus)
        : undefined,
    };
  },
...
export const UsageTracker_SkuWithFieldValue: MessageFns<UsageTracker_SkuWithFieldValue> = {
  encode(message: UsageTracker_SkuWithFieldValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UsageTracker_SkuWithFieldValue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): UsageTracker_SkuWithFieldValue {
    return {
      fieldValue: globalThis.Array.isArray(object?.fieldValue)
        ...
        : globalThis.Array.isArray(object?.field_value)
        ? object.field_value.map((e: any) => globalThis.String(e))
        : [],
      apiSku: isSet(object.apiSku)
        ? globalThis.String(object.apiSku)
        : isSet(object.api_sku)
...
export const UsageTracker_SkusByField: MessageFns<UsageTracker_SkusByField> = {
  encode(message: UsageTracker_SkusByField, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fieldName !== "") {
      writer.uint32(10).string(message.fieldName);
    }
    for (const v of message.skus) {
      UsageTracker_SkuWithFieldValue.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UsageTracker_SkusByField {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const UsageTracker_CustomSkus: MessageFns<UsageTracker_CustomSkus> = {
  encode(message: UsageTracker_CustomSkus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.skusByField) {
      UsageTracker_SkusByField.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UsageTracker_CustomSkus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): UsageTracker_CustomSkus {
    return {
      skusByField: globalThis.Array.isArray(object?.skusByField)
        ...
        : globalThis.Array.isArray(object?.skus_by_field)
        ? object.skus_by_field.map((e: any) => UsageTracker_SkusByField.fromJSON(e))
        : [],
      multipleFieldSkusOp: isSet(object.multipleFieldSkusOp)
        ? usageTracker_CustomSkus_SkuOpFromJSON(object.multipleFieldSkusOp)
        : isSet(object.multiple_field_skus_op)
        ? usageTracker_CustomSkus_SkuOpFromJSON(object.multiple_field_skus_op)
        : 0,
    };
  },
...
export const Auth: MessageFns<Auth> = {
  encode(message: Auth, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.metadata).forEach(([key, value]: [string, string]) => {
      Auth_MetadataEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
  ...
  fromJSON(object: any): Auth {
    return {
      ...
      metadata: isObject(object.metadata)
        ...
        : {},
      allowAnonymous: isSet(object.allowAnonymous)
        ? globalThis.Boolean(object.allowAnonymous)
        : isSet(object.allow_anonymous)
        ? globalThis.Boolean(object.allow_anonymous)
        : false,
    };
  },
...
export const Auth_MetadataEntry: MessageFns<Auth_MetadataEntry> = {
  encode(message: Auth_MetadataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Auth_MetadataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AccessMeta: MessageFns<AccessMeta> = {
  encode(message: AccessMeta, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectIdField !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AccessMeta {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): AccessMeta {
    return {
      ...
      projectSlugField: isSet(object.projectSlugField)
        ...
        ? globalThis.String(object.project_slug_field)
        : "",
      ownerIdField: isSet(object.ownerIdField)
        ? globalThis.String(object.ownerIdField)
        : isSet(object.owner_id_field)
        ? globalThis.String(object.owner_id_field)
        : "",
      ownerNameField: isSet(object.ownerNameField)
        ? globalThis.String(object.ownerNameField)
        : isSet(object.owner_name_field)
        ? globalThis.String(object.owner_name_field)
        : "",
      processorIdField: isSet(object.processorIdField)
        ? globalThis.String(object.processorIdField)
        : isSet(object.processor_id_field)
        ? globalThis.String(object.processor_id_field)
        : "",
      processorVersionField: isSet(object.processorVersionField)
        ? globalThis.String(object.processorVersionField)
        : isSet(object.processor_version_field)
  ...
  fromJSON(object: any): User {
    return {
      ...
      accountStatus: isSet(object.accountStatus)
        ? user_AccountStatusFromJSON(object.accountStatus)
        : isSet(object.account_status)
        ? user_AccountStatusFromJSON(object.account_status)
        : 0,
      tier: isSet(object.tier) ? tierFromJSON(object.tier) : 0,
      isOrganization: isSet(object.isOrganization)
        ? globalThis.Boolean(object.isOrganization)
        : isSet(object.is_organization)
        ? globalThis.Boolean(object.is_organization)
        : false,
...
export const Project: MessageFns<Project> = {
  encode(message: Project, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.owner !== undefined) {
      Owner.encode(message.owner, writer.uint32(66).fork()).join();
    }
    ...
    for (const v of message.members) {
      Project_ProjectMember.encode(v!, writer.uint32(90).fork()).join();
    }
    ...
    for (const v of message.notificationChannels) {
      Channel.encode(v!, writer.uint32(114).fork()).join();
    }
    for (const v of message.views) {
      ProjectView.encode(v!, writer.uint32(122).fork()).join();
    }
    if (message.supersetEnable !== false) {
      writer.uint32(136).bool(message.supersetEnable);
    }
    if (message.superset !== undefined) {
      ProjectSuperset.encode(message.superset, writer.uint32(146).fork()).join();
    }
    ...
    if (message.defaultTimerange !== undefined) {
      TimeRangeLite.encode(message.defaultTimerange, writer.uint32(170).fork()).join();
    }
    if (message.communityProject !== undefined) {
      CommunityProject.encode(message.communityProject, writer.uint32(178).fork()).join();
    }
  ...
  fromJSON(object: any): Project {
    return {
      ...
      members: globalThis.Array.isArray(object?.members)
        ...
        : [],
      multiVersion: isSet(object.multiVersion)
        ? globalThis.Boolean(object.multiVersion)
        : isSet(object.multi_version)
        ? globalThis.Boolean(object.multi_version)
        : false,
      ...
      notificationChannels: globalThis.Array.isArray(object?.notificationChannels)
        ...
        : globalThis.Array.isArray(object?.notification_channels)
        ? object.notification_channels.map((e: any) => Channel.fromJSON(e))
        : [],
      views: globalThis.Array.isArray(object?.views) ? object.views.map((e: any) => ProjectView.fromJSON(e)) : [],
      supersetEnable: isSet(object.supersetEnable)
        ? globalThis.Boolean(object.supersetEnable)
        : isSet(object.superset_enable)
        ? globalThis.Boolean(object.superset_enable)
        : false,
      superset: isSet(object.superset) ? ProjectSuperset.fromJSON(object.superset) : undefined,
      enableDisk: isSet(object.enableDisk)
        ? globalThis.Boolean(object.enableDisk)
        : isSet(object.enable_disk)
        ? globalThis.Boolean(object.enable_disk)
        : false,
      enableMaterializedView: isSet(object.enableMaterializedView)
        ? globalThis.Boolean(object.enableMaterializedView)
        : isSet(object.enable_materialized_view)
        ? globalThis.Boolean(object.enable_materialized_view)
        : false,
      defaultTimerange: isSet(object.defaultTimerange)
        ? TimeRangeLite.fromJSON(object.defaultTimerange)
        : isSet(object.default_timerange)
        ? TimeRangeLite.fromJSON(object.default_timerange)
        : undefined,
      communityProject: isSet(object.communityProject)
        ? CommunityProject.fromJSON(object.communityProject)
        : isSet(object.community_project)
        ? CommunityProject.fromJSON(object.community_project)
        : undefined,
      sentioNetwork: isSet(object.sentioNetwork)
        ? globalThis.Boolean(object.sentioNetwork)
        : isSet(object.sentio_network)
        ? globalThis.Boolean(object.sentio_network)
        : false,
    };
  },
...
export const Project_ProjectMember: MessageFns<Project_ProjectMember> = {
  encode(message: Project_ProjectMember, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Project_ProjectMember {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CommunityProject: MessageFns<CommunityProject> = {
  encode(message: CommunityProject, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.chain).forEach(([key, value]: [string, StringList]) => {
      CommunityProject_ChainEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CommunityProject {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CommunityProject {
    return {
      dashAlias: isSet(object.dashAlias)
        ? globalThis.String(object.dashAlias)
        : isSet(object.dash_alias)
        ? globalThis.String(object.dash_alias)
        : "",
      curated: isSet(object.curated) ? globalThis.Boolean(object.curated) : undefined,
      chain: isObject(object.chain)
        ? (globalThis.Object.entries(object.chain) as [string, any][]).reduce(
  ...
  toJSON(message: CommunityProject): unknown {
    ...
    if (message.chain) {
      const entries = globalThis.Object.entries(message.chain) as [string, StringList][];
      if (entries.length > 0) {
        obj.chain = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<CommunityProject>): CommunityProject {
    ...
    message.chain = (globalThis.Object.entries(object.chain ?? {}) as [string, StringList][]).reduce(
      (acc: { [key: string]: StringList }, [key, value]: [string, StringList]) => {
        if (value !== undefined) {
...
export const CommunityProject_ChainEntry: MessageFns<CommunityProject_ChainEntry> = {
  encode(message: CommunityProject_ChainEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CommunityProject_ChainEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectInfo: MessageFns<ProjectInfo> = {
  encode(message: ProjectInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.superset !== undefined) {
      ProjectSuperset.encode(message.superset, writer.uint32(114).fork()).join();
    }
    if (message.enableDisk !== false) {
      writer.uint32(152).bool(message.enableDisk);
    }
...
export const EventLogColumn: MessageFns<EventLogColumn> = {
  encode(message: EventLogColumn, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.size !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventLogColumn {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ColumnState: MessageFns<ColumnState> = {
  encode(message: ColumnState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.columnSizing).forEach(([key, value]: [string, number]) => {
      ColumnState_ColumnSizingEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    globalThis.Object.entries(message.columnVisibility).forEach(([key, value]: [string, boolean]) => {
      ColumnState_ColumnVisibilityEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    for (const v of message.columnOrder) {
      writer.uint32(26).string(v!);
    }
    for (const v of message.sorting) {
      ColumnState_Sort.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ColumnState {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ColumnState {
    return {
      columnSizing: isObject(object.columnSizing)
        ? (globalThis.Object.entries(object.columnSizing) as [string, any][]).reduce(
      ...
      columnVisibility: isObject(object.columnVisibility)
        ? (globalThis.Object.entries(object.columnVisibility) as [string, any][]).reduce(
  ...
  toJSON(message: ColumnState): unknown {
    ...
    if (message.columnSizing) {
      const entries = globalThis.Object.entries(message.columnSizing) as [string, number][];
      if (entries.length > 0) {
        obj.columnSizing = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.columnVisibility) {
      const entries = globalThis.Object.entries(message.columnVisibility) as [string, boolean][];
      if (entries.length > 0) {
  ...
  fromPartial(object: DeepPartial<ColumnState>): ColumnState {
    const message = createBaseColumnState();
    message.columnSizing = (globalThis.Object.entries(object.columnSizing ?? {}) as [string, number][]).reduce(
    ...
    message.columnVisibility = (globalThis.Object.entries(object.columnVisibility ?? {}) as [string, boolean][]).reduce(
...
export const ColumnState_ColumnSizingEntry: MessageFns<ColumnState_ColumnSizingEntry> = {
  encode(message: ColumnState_ColumnSizingEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ColumnState_ColumnSizingEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ColumnState_ColumnVisibilityEntry: MessageFns<ColumnState_ColumnVisibilityEntry> = {
  encode(message: ColumnState_ColumnVisibilityEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ColumnState_ColumnVisibilityEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ColumnState_Sort: MessageFns<ColumnState_Sort> = {
  encode(message: ColumnState_Sort, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ColumnState_Sort {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const EventLogConfig: MessageFns<EventLogConfig> = {
  encode(message: EventLogConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.columns) {
      EventLogColumn.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.state !== undefined) {
      ColumnState.encode(message.state, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const ProjectView: MessageFns<ProjectView> = {
  encode(message: ProjectView, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    ...
    if (message.config !== undefined) {
      ProjectView_ProjectViewConfig.encode(message.config, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectView {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectView_ProjectViewConfig: MessageFns<ProjectView_ProjectViewConfig> = {
  encode(message: ProjectView_ProjectViewConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.eventLog !== undefined) {
      EventLogConfig.encode(message.eventLog, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectView_ProjectViewConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ProjectView_ProjectViewConfig {
    return {
      eventLog: isSet(object.eventLog)
        ? EventLogConfig.fromJSON(object.eventLog)
        : isSet(object.event_log)
        ? EventLogConfig.fromJSON(object.event_log)
        : undefined,
    };
  },
...
export const Organization: MessageFns<Organization> = {
  encode(message: Organization, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.members) {
      Organization_Member.encode(v!, writer.uint32(50).fork()).join();
    }
    if (message.displayName !== "") {
    ...
    for (const v of message.projects) {
      ProjectInfo.encode(v!, writer.uint32(74).fork()).join();
    }
    if (message.tier !== 0) {
...
export const Organization_Member: MessageFns<Organization_Member> = {
  encode(message: Organization_Member, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.user !== undefined) {
      UserInfo.encode(message.user, writer.uint32(10).fork()).join();
    }
    if (message.role !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Organization_Member {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ApiKey: MessageFns<ApiKey> = {
  encode(message: ApiKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.scopeProjects).forEach(([key, value]: [string, ProjectInfo]) => {
      ApiKey_ScopeProjectsEntry.encode({ key: key as any, value }, writer.uint32(98).fork()).join();
    });
    return writer;
  },
  ...
  fromJSON(object: any): ApiKey {
    return {
      ...
      ownerType: isSet(object.ownerType)
        ? globalThis.String(object.ownerType)
        : isSet(object.owner_type)
        ? globalThis.String(object.owner_type)
        : "",
      revealable: isSet(object.revealable) ? globalThis.Boolean(object.revealable) : false,
      scopeProjects: isObject(object.scopeProjects)
        ? (globalThis.Object.entries(object.scopeProjects) as [string, any][]).reduce(
          (acc: { [key: string]: ProjectInfo }, [key, value]: [string, any]) => {
            acc[key] = ProjectInfo.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.scope_projects)
        ? (globalThis.Object.entries(object.scope_projects) as [string, any][]).reduce(
          (acc: { [key: string]: ProjectInfo }, [key, value]: [string, any]) => {
            acc[key] = ProjectInfo.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: ApiKey): unknown {
    ...
    if (message.scopeProjects) {
      const entries = globalThis.Object.entries(message.scopeProjects) as [string, ProjectInfo][];
      if (entries.length > 0) {
        obj.scopeProjects = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<ApiKey>): ApiKey {
    ...
    message.scopeProjects = (globalThis.Object.entries(object.scopeProjects ?? {}) as [string, ProjectInfo][]).reduce(
      (acc: { [key: string]: ProjectInfo }, [key, value]: [string, ProjectInfo]) => {
        if (value !== undefined) {
...
export const ApiKey_ScopeProjectsEntry: MessageFns<ApiKey_ScopeProjectsEntry> = {
  encode(message: ApiKey_ScopeProjectsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      ProjectInfo.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ApiKey_ScopeProjectsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TimeRangeLite: MessageFns<TimeRangeLite> = {
  encode(message: TimeRangeLite, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.start !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TimeRangeLite {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseTimeRange(): TimeRange {
  return { start: undefined, end: undefined, step: 0n, interval: undefined, timezone: "" };
}
...
export const TimeRange: MessageFns<TimeRange> = {
  encode(message: TimeRange, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.start !== undefined) {
      TimeRange_TimeLike.encode(message.start, writer.uint32(10).fork()).join();
    }
    if (message.end !== undefined) {
      TimeRange_TimeLike.encode(message.end, writer.uint32(18).fork()).join();
    }
    if (message.step !== 0n) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.step = reader.int64() as bigint;
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): TimeRange {
    return {
      ...
      step: isSet(object.step) ? BigInt(object.step) : 0n,
...
export const TimeRange_TimeLike: MessageFns<TimeRange_TimeLike> = {
  encode(message: TimeRange_TimeLike, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.relativeTime !== undefined) {
      TimeRange_RelativeTime.encode(message.relativeTime, writer.uint32(10).fork()).join();
    }
    if (message.absoluteTime !== undefined) {
      ...
      writer.uint32(16).int64(message.absoluteTime);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TimeRange_TimeLike {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.absoluteTime = reader.int64() as bigint;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TimeRange_TimeLike {
    return {
      relativeTime: isSet(object.relativeTime)
        ? TimeRange_RelativeTime.fromJSON(object.relativeTime)
        : isSet(object.relative_time)
        ? TimeRange_RelativeTime.fromJSON(object.relative_time)
        : undefined,
      absoluteTime: isSet(object.absoluteTime)
        ? BigInt(object.absoluteTime)
        : isSet(object.absolute_time)
        ? BigInt(object.absolute_time)
        : undefined,
    };
  },
...
export const TimeRange_RelativeTime: MessageFns<TimeRange_RelativeTime> = {
  encode(message: TimeRange_RelativeTime, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.unit !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TimeRange_RelativeTime {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Formula: MessageFns<Formula> = {
  encode(message: Formula, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.functions) {
      FunctionMessage.encode(v!, writer.uint32(50).fork()).join();
    }
    if (message.color !== "") {
...
export const Argument: MessageFns<Argument> = {
  encode(message: Argument, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.durationValue !== undefined) {
      Duration.encode(message.durationValue, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export const Query: MessageFns<Query> = {
  encode(message: Query, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.labelSelector).forEach(([key, value]: [string, string]) => {
      Query_LabelSelectorEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
    });
    if (message.aggregate !== undefined) {
      Aggregate.encode(message.aggregate, writer.uint32(50).fork()).join();
    }
    for (const v of message.functions) {
      FunctionMessage.encode(v!, writer.uint32(58).fork()).join();
    }
    if (message.color !== "") {
  ...
  fromJSON(object: any): Query {
    return {
      ...
      labelSelector: isObject(object.labelSelector)
        ? (globalThis.Object.entries(object.labelSelector) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
        ...
        : isObject(object.label_selector)
        ? (globalThis.Object.entries(object.label_selector) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
  ...
  toJSON(message: Query): unknown {
    ...
    if (message.labelSelector) {
      const entries = globalThis.Object.entries(message.labelSelector) as [string, string][];
      if (entries.length > 0) {
        obj.labelSelector = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<Query>): Query {
    ...
    message.alias = object.alias ?? "";
    message.id = object.id ?? "";
    message.labelSelector = (globalThis.Object.entries(object.labelSelector ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
...
export const Query_LabelSelectorEntry: MessageFns<Query_LabelSelectorEntry> = {
  encode(message: Query_LabelSelectorEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Query_LabelSelectorEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Aggregate: MessageFns<Aggregate> = {
  encode(message: Aggregate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.op !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Aggregate {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SelectorExpr: MessageFns<SelectorExpr> = {
  encode(message: SelectorExpr, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.selector !== undefined) {
      Selector.encode(message.selector, writer.uint32(10).fork()).join();
    }
    if (message.logicExpr !== undefined) {
      SelectorExpr_LogicExpr.encode(message.logicExpr, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SelectorExpr {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SelectorExpr {
    return {
      ...
      logicExpr: isSet(object.logicExpr)
        ? SelectorExpr_LogicExpr.fromJSON(object.logicExpr)
        : isSet(object.logic_expr)
        ? SelectorExpr_LogicExpr.fromJSON(object.logic_expr)
        : undefined,
    };
  },
...
export const SelectorExpr_LogicExpr: MessageFns<SelectorExpr_LogicExpr> = {
  encode(message: SelectorExpr_LogicExpr, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.expressions) {
      SelectorExpr.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.operator !== 0) {
      writer.uint32(16).int32(message.operator);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SelectorExpr_LogicExpr {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CohortsGroup: MessageFns<CohortsGroup> = {
  encode(message: CohortsGroup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.joinOperator !== 0) {
      writer.uint32(8).int32(message.joinOperator);
    }
    for (const v of message.filters) {
      CohortsFilter.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CohortsGroup {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CohortsGroup {
    return {
      joinOperator: isSet(object.joinOperator)
        ? joinOperatorFromJSON(object.joinOperator)
        : isSet(object.join_operator)
        ? joinOperatorFromJSON(object.join_operator)
        : 0,
...
export const CohortsQuery: MessageFns<CohortsQuery> = {
  encode(message: CohortsQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.joinOperator !== 0) {
      writer.uint32(8).int32(message.joinOperator);
    }
    for (const v of message.groups) {
      CohortsGroup.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.name !== "") {
      writer.uint32(26).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CohortsQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SegmentationQuery: MessageFns<SegmentationQuery> = {
  encode(message: SegmentationQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.resource !== undefined) {
      SegmentationQuery_Resource.encode(message.resource, writer.uint32(10).fork()).join();
    }
    if (message.alias !== "") {
      writer.uint32(18).string(message.alias);
    }
    ...
    if (message.aggregation !== undefined) {
      SegmentationQuery_Aggregation.encode(message.aggregation, writer.uint32(34).fork()).join();
    }
    if (message.selectorExpr !== undefined) {
      SegmentationQuery_SelectorExpr.encode(message.selectorExpr, writer.uint32(42).fork()).join();
    }
    ...
    for (const v of message.functions) {
      FunctionMessage.encode(v!, writer.uint32(74).fork()).join();
    }
    if (message.color !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SegmentationQuery {
    return {
      ...
      selectorExpr: isSet(object.selectorExpr)
        ...
        : isSet(object.selector_expr)
        ? SegmentationQuery_SelectorExpr.fromJSON(object.selector_expr)
        : undefined,
...
function createBaseSegmentationQuery_Resource(): SegmentationQuery_Resource {
  return { name: "", type: 0, cohortsId: undefined, cohortsQuery: undefined, multipleNames: [] };
}

export const SegmentationQuery_Resource: MessageFns<SegmentationQuery_Resource> = {
  encode(message: SegmentationQuery_Resource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.type !== 0) {
    ...
    if (message.cohortsQuery !== undefined) {
      CohortsQuery.encode(message.cohortsQuery, writer.uint32(34).fork()).join();
    }
    for (const v of message.multipleNames) {
      writer.uint32(42).string(v!);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery_Resource {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.multipleNames.push(reader.string());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SegmentationQuery_Resource {
    return {
      ...
      cohortsId: isSet(object.cohortsId)
        ? globalThis.String(object.cohortsId)
        : isSet(object.cohorts_id)
        ? globalThis.String(object.cohorts_id)
        : undefined,
      cohortsQuery: isSet(object.cohortsQuery)
        ? CohortsQuery.fromJSON(object.cohortsQuery)
        : isSet(object.cohorts_query)
        ? CohortsQuery.fromJSON(object.cohorts_query)
        : undefined,
      multipleNames: globalThis.Array.isArray(object?.multipleNames)
        ? object.multipleNames.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.multiple_names)
        ? object.multiple_names.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: SegmentationQuery_Resource): unknown {
    ...
    if (message.multipleNames?.length) {
      obj.multipleNames = message.multipleNames;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SegmentationQuery_Resource>): SegmentationQuery_Resource {
    ...
    message.cohortsQuery = (object.cohortsQuery !== undefined && object.cohortsQuery !== null)
      ...
      : undefined;
    message.multipleNames = object.multipleNames?.map((e) => e) || [];
    return message;
  },
};
...
export const SegmentationQuery_Aggregation: MessageFns<SegmentationQuery_Aggregation> = {
  encode(message: SegmentationQuery_Aggregation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.total !== undefined) {
      SegmentationQuery_Aggregation_Total.encode(message.total, writer.uint32(10).fork()).join();
    }
    if (message.unique !== undefined) {
      SegmentationQuery_Aggregation_Unique.encode(message.unique, writer.uint32(18).fork()).join();
    }
    if (message.countUnique !== undefined) {
      SegmentationQuery_Aggregation_CountUnique.encode(message.countUnique, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery_Aggregation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SegmentationQuery_Aggregation {
    return {
      ...
      countUnique: isSet(object.countUnique)
        ...
        : isSet(object.count_unique)
        ? SegmentationQuery_Aggregation_CountUnique.fromJSON(object.count_unique)
        : undefined,
      aggregateProperties: isSet(object.aggregateProperties)
        ...
        : isSet(object.aggregate_properties)
        ? SegmentationQuery_Aggregation_AggregateProperties.fromJSON(object.aggregate_properties)
        : undefined,
    };
  },
...
export const SegmentationQuery_Aggregation_Total: MessageFns<SegmentationQuery_Aggregation_Total> = {
  encode(_: SegmentationQuery_Aggregation_Total, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery_Aggregation_Total {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SegmentationQuery_Aggregation_Unique: MessageFns<SegmentationQuery_Aggregation_Unique> = {
  encode(_: SegmentationQuery_Aggregation_Unique, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery_Aggregation_Unique {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SegmentationQuery_Aggregation_CountUnique: MessageFns<SegmentationQuery_Aggregation_CountUnique> = {
  encode(message: SegmentationQuery_Aggregation_CountUnique, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery_Aggregation_CountUnique {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SegmentationQuery_Aggregation_AggregateProperties: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery_Aggregation_AggregateProperties {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SegmentationQuery_SelectorExpr: MessageFns<SegmentationQuery_SelectorExpr> = {
  encode(message: SegmentationQuery_SelectorExpr, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.selector !== undefined) {
      Selector.encode(message.selector, writer.uint32(10).fork()).join();
    }
    if (message.logicExpr !== undefined) {
      SegmentationQuery_SelectorExpr_LogicExpr.encode(message.logicExpr, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery_SelectorExpr {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SegmentationQuery_SelectorExpr {
    return {
      ...
      logicExpr: isSet(object.logicExpr)
        ...
        : isSet(object.logic_expr)
        ? SegmentationQuery_SelectorExpr_LogicExpr.fromJSON(object.logic_expr)
        : undefined,
    };
  },
...
export const SegmentationQuery_SelectorExpr_LogicExpr: MessageFns<SegmentationQuery_SelectorExpr_LogicExpr> = {
  encode(message: SegmentationQuery_SelectorExpr_LogicExpr, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.expressions) {
      SegmentationQuery_SelectorExpr.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.operator !== 0) {
      writer.uint32(16).int32(message.operator);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SegmentationQuery_SelectorExpr_LogicExpr {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CohortsFilter: MessageFns<CohortsFilter> = {
  encode(message: CohortsFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.aggregation !== undefined) {
      CohortsFilter_Aggregation.encode(message.aggregation, writer.uint32(26).fork()).join();
    }
    if (message.selectorExpr !== undefined) {
      SelectorExpr.encode(message.selectorExpr, writer.uint32(34).fork()).join();
    }
    if (message.timeRange !== undefined) {
      TimeRangeLite.encode(message.timeRange, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CohortsFilter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CohortsFilter {
    return {
      ...
      selectorExpr: isSet(object.selectorExpr)
        ...
        : isSet(object.selector_expr)
        ? SelectorExpr.fromJSON(object.selector_expr)
        : undefined,
      timeRange: isSet(object.timeRange)
        ? TimeRangeLite.fromJSON(object.timeRange)
        : isSet(object.time_range)
        ? TimeRangeLite.fromJSON(object.time_range)
        : undefined,
    };
  },
...
export const CohortsFilter_Aggregation: MessageFns<CohortsFilter_Aggregation> = {
  encode(message: CohortsFilter_Aggregation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.total !== undefined) {
      CohortsFilter_Aggregation_Total.encode(message.total, writer.uint32(10).fork()).join();
    }
    if (message.aggregateProperties !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CohortsFilter_Aggregation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CohortsFilter_Aggregation_Total: MessageFns<CohortsFilter_Aggregation_Total> = {
  encode(_: CohortsFilter_Aggregation_Total, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CohortsFilter_Aggregation_Total {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CohortsFilter_Aggregation_AggregateProperties: MessageFns<CohortsFilter_Aggregation_AggregateProperties> =
  {
    encode(
      message: CohortsFilter_Aggregation_AggregateProperties,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
      if (message.type !== 0) {
        writer.uint32(8).int32(message.type);
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): CohortsFilter_Aggregation_AggregateProperties {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      const end = length === undefined ? reader.len : reader.pos + length;
    ...
    fromJSON(object: any): CohortsFilter_Aggregation_AggregateProperties {
      return {
        type: isSet(object.type)
          ? cohortsFilter_Aggregation_AggregateProperties_AggregationTypeFromJSON(object.type)
          : 0,
        propertyName: isSet(object.propertyName)
          ? globalThis.String(object.propertyName)
          : isSet(object.property_name)
...
export const ErrorRecord: MessageFns<ErrorRecord> = {
  ...
  fromJSON(object: any): ErrorRecord {
    return {
      ...
      namespaceCode: isSet(object.namespaceCode)
        ? globalThis.Number(object.namespaceCode)
        : isSet(object.namespace_code)
        ? globalThis.Number(object.namespace_code)
        : 0,
...
export const Any: MessageFns<Any> = {
  encode(message: Any, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.dateValue !== undefined) {
      Timestamp.encode(toTimestamp(message.dateValue), writer.uint32(50).fork()).join();
    }
    if (message.listValue !== undefined) {
      StringList.encode(message.listValue, writer.uint32(58).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.longValue = reader.int64() as bigint;
          continue;
        }
        case 3: {
          if (tag !== 25) {
  ...
  fromJSON(object: any): Any {
    return {
      intValue: isSet(object.intValue)
        ...
        ? globalThis.Number(object.int_value)
        : undefined,
      longValue: isSet(object.longValue)
        ? BigInt(object.longValue)
        : isSet(object.long_value)
        ? BigInt(object.long_value)
        : undefined,
      doubleValue: isSet(object.doubleValue)
        ? globalThis.Number(object.doubleValue)
        : isSet(object.double_value)
      ...
      dateValue: isSet(object.dateValue)
        ? fromJsonTimestamp(object.dateValue)
        : isSet(object.date_value)
        ? fromJsonTimestamp(object.date_value)
        : undefined,
      listValue: isSet(object.listValue)
        ? StringList.fromJSON(object.listValue)
        : isSet(object.list_value)
        ? StringList.fromJSON(object.list_value)
        : undefined,
    };
  },
...
export const Channel: MessageFns<Channel> = {
  encode(message: Channel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.customHeaders).forEach(([key, value]: [string, string]) => {
      Channel_CustomHeadersEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).join();
    });
    ...
    if (message.pagerdutyConfig !== undefined) {
      Struct.encode(Struct.wrap(message.pagerdutyConfig), writer.uint32(106).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Channel {
    return {
      ...
      emailAddress: isSet(object.emailAddress)
        ...
        : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      customWebhookUrl: isSet(object.customWebhookUrl)
        ? globalThis.String(object.customWebhookUrl)
        : isSet(object.custom_webhook_url)
        ? globalThis.String(object.custom_webhook_url)
        : "",
      customHeaders: isObject(object.customHeaders)
        ? (globalThis.Object.entries(object.customHeaders) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
        ...
        : isObject(object.custom_headers)
        ? (globalThis.Object.entries(object.custom_headers) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
        ...
        : {},
      telegramReference: isSet(object.telegramReference)
        ? globalThis.String(object.telegramReference)
        : isSet(object.telegram_reference)
        ? globalThis.String(object.telegram_reference)
        : "",
      telegramChatId: isSet(object.telegramChatId)
        ? globalThis.String(object.telegramChatId)
        : isSet(object.telegram_chat_id)
        ? globalThis.String(object.telegram_chat_id)
        : "",
      slackTeam: isSet(object.slackTeam)
        ? globalThis.String(object.slackTeam)
        : isSet(object.slack_team)
        ? globalThis.String(object.slack_team)
        : "",
      slackChannel: isSet(object.slackChannel)
        ? globalThis.String(object.slackChannel)
        : isSet(object.slack_channel)
        ? globalThis.String(object.slack_channel)
        : "",
      pagerdutyConfig: isObject(object.pagerdutyConfig)
        ? object.pagerdutyConfig
        : isObject(object.pagerduty_config)
        ? object.pagerduty_config
        : undefined,
    };
  },
  ...
  toJSON(message: Channel): unknown {
    ...
    if (message.customHeaders) {
      const entries = globalThis.Object.entries(message.customHeaders) as [string, string][];
      if (entries.length > 0) {
        obj.customHeaders = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<Channel>): Channel {
    ...
    message.customHeaders = (globalThis.Object.entries(object.customHeaders ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
...
export const Channel_CustomHeadersEntry: MessageFns<Channel_CustomHeadersEntry> = {
  encode(message: Channel_CustomHeadersEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Channel_CustomHeadersEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const EventLogEntry: MessageFns<EventLogEntry> = {
  encode(message: EventLogEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.message !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventLogEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): EventLogEntry {
    return {
      ...
      transactionHash: isSet(object.transactionHash)
        ...
        : "",
      highlightedMessage: isSet(object.highlightedMessage)
        ? globalThis.String(object.highlightedMessage)
        : isSet(object.highlighted_message)
        ? globalThis.String(object.highlighted_message)
        : "",
...
export const Matrix: MessageFns<Matrix> = {
  encode(message: Matrix, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.samples) {
      Matrix_Sample.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Matrix {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Matrix {
    return {
      samples: globalThis.Array.isArray(object?.samples)
        ...
        : [],
      totalSamples: isSet(object.totalSamples)
        ? globalThis.Number(object.totalSamples)
        : isSet(object.total_samples)
        ? globalThis.Number(object.total_samples)
        : 0,
    };
  },
...
export const Matrix_Sample: MessageFns<Matrix_Sample> = {
  encode(message: Matrix_Sample, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.metric !== undefined) {
      Matrix_Metric.encode(message.metric, writer.uint32(10).fork()).join();
    }
    for (const v of message.values) {
      Matrix_Value.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Matrix_Sample {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Matrix_Metric: MessageFns<Matrix_Metric> = {
  encode(message: Matrix_Metric, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    globalThis.Object.entries(message.labels).forEach(([key, value]: [string, string]) => {
      Matrix_Metric_LabelsEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    if (message.displayName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Matrix_Metric {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Matrix_Metric_LabelsEntry: MessageFns<Matrix_Metric_LabelsEntry> = {
  encode(message: Matrix_Metric_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Matrix_Metric_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseMatrix_Value(): Matrix_Value {
  return { timestamp: 0n, value: 0 };
}

export const Matrix_Value: MessageFns<Matrix_Value> = {
  encode(message: Matrix_Value, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.timestamp !== 0n) {
      if (BigInt.asIntN(64, message.timestamp) !== message.timestamp) {
        throw new globalThis.Error("value provided for field message.timestamp of type int64 too large");
      }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Matrix_Value {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DashboardSharingRequest: MessageFns<DashboardSharingRequest> = {
  encode(message: DashboardSharingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.timeRange !== undefined) {
      TimeRangeLite.encode(message.timeRange, writer.uint32(50).fork()).join();
    }
    if (message.version !== 0) {
      writer.uint32(56).int32(message.version);
    }
    if (message.variables !== undefined) {
      Struct.encode(Struct.wrap(message.variables), writer.uint32(66).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DashboardSharingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DashboardSharingRequest {
    return {
      sharingId: isSet(object.sharingId)
        ? globalThis.String(object.sharingId)
        : isSet(object.sharing_id)
        ? globalThis.String(object.sharing_id)
        : "",
      panelId: isSet(object.panelId)
        ...
        : "",
      samplesLimit: isSet(object.samplesLimit)
        ? globalThis.Number(object.samplesLimit)
        : isSet(object.samples_limit)
        ? globalThis.Number(object.samples_limit)
        : 0,
      timeRange: isSet(object.timeRange)
        ? TimeRangeLite.fromJSON(object.timeRange)
        : isSet(object.time_range)
      ...
      samplesOffset: isSet(object.samplesOffset)
        ? globalThis.Number(object.samplesOffset)
        : isSet(object.samples_offset)
        ? globalThis.Number(object.samples_offset)
        : 0,
    };
  },
...
export const UserUsage: MessageFns<UserUsage> = {
  encode(message: UserUsage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tier !== 0) {
    ...
    globalThis.Object.entries(message.usageByProjects).forEach(([key, value]: [string, UserUsage_ProjectUsage]) => {
      UserUsage_UsageByProjectsEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UserUsage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): UserUsage {
    return {
      ...
      usageByProjects: isObject(object.usageByProjects)
        ? (globalThis.Object.entries(object.usageByProjects) as [string, any][]).reduce(
          (acc: { [key: string]: UserUsage_ProjectUsage }, [key, value]: [string, any]) => {
            acc[key] = UserUsage_ProjectUsage.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.usage_by_projects)
        ? (globalThis.Object.entries(object.usage_by_projects) as [string, any][]).reduce(
          (acc: { [key: string]: UserUsage_ProjectUsage }, [key, value]: [string, any]) => {
            acc[key] = UserUsage_ProjectUsage.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: UserUsage): unknown {
    ...
    if (message.usageByProjects) {
      const entries = globalThis.Object.entries(message.usageByProjects) as [string, UserUsage_ProjectUsage][];
      if (entries.length > 0) {
        obj.usageByProjects = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<UserUsage>): UserUsage {
    ...
    message.usageByProjects =
      (globalThis.Object.entries(object.usageByProjects ?? {}) as [string, UserUsage_ProjectUsage][]).reduce(
        (acc: { [key: string]: UserUsage_ProjectUsage }, [key, value]: [string, UserUsage_ProjectUsage]) => {
          if (value !== undefined) {
...
function createBaseUserUsage_ProjectUsage(): UserUsage_ProjectUsage {
  return { owner: "", slug: "", cost: 0n };
}

export const UserUsage_ProjectUsage: MessageFns<UserUsage_ProjectUsage> = {
  encode(message: UserUsage_ProjectUsage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.owner !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserUsage_ProjectUsage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const UserUsage_UsageByProjectsEntry: MessageFns<UserUsage_UsageByProjectsEntry> = {
  encode(message: UserUsage_UsageByProjectsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      UserUsage_ProjectUsage.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UserUsage_UsageByProjectsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CoinID: MessageFns<CoinID> = {
  encode(message: CoinID, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.symbol !== undefined) {
      writer.uint32(10).string(message.symbol);
    }
    if (message.address !== undefined) {
      CoinID_AddressIdentifier.encode(message.address, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CoinID {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CoinID_AddressIdentifier: MessageFns<CoinID_AddressIdentifier> = {
  encode(message: CoinID_AddressIdentifier, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (message.chain !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CoinID_AddressIdentifier {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const PriceSegmentationQuery: MessageFns<PriceSegmentationQuery> = {
  encode(message: PriceSegmentationQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.alias !== "") {
    ...
    for (const v of message.coinId) {
      CoinID.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.color !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PriceSegmentationQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PriceSegmentationQuery {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      alias: isSet(object.alias) ? globalThis.String(object.alias) : "",
      coinId: globalThis.Array.isArray(object?.coinId)
        ? object.coinId.map((e: any) => CoinID.fromJSON(e))
        : globalThis.Array.isArray(object?.coin_id)
        ? object.coin_id.map((e: any) => CoinID.fromJSON(e))
        : [],
      color: isSet(object.color) ? globalThis.String(object.color) : "",
      disabled: isSet(object.disabled) ? globalThis.Boolean(object.disabled) : false,
    };
...
export const TabularData: MessageFns<TabularData> = {
  encode(message: TabularData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.columns) {
      writer.uint32(10).string(v!);
    }
    globalThis.Object.entries(message.columnTypes).forEach(([key, value]: [string, TabularData_ColumnType]) => {
      TabularData_ColumnTypesEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    for (const v of message.rows) {
      Struct.encode(Struct.wrap(v!), writer.uint32(26).fork()).join();
    }
    if (message.generatedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.generatedAt), writer.uint32(34).fork()).join();
    }
    if (message.cursor !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TabularData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): TabularData {
    return {
      ...
      columnTypes: isObject(object.columnTypes)
        ? (globalThis.Object.entries(object.columnTypes) as [string, any][]).reduce(
          (acc: { [key: string]: TabularData_ColumnType }, [key, value]: [string, any]) => {
            acc[key] = tabularData_ColumnTypeFromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.column_types)
        ? (globalThis.Object.entries(object.column_types) as [string, any][]).reduce(
          (acc: { [key: string]: TabularData_ColumnType }, [key, value]: [string, any]) => {
            acc[key] = tabularData_ColumnTypeFromJSON(value);
            return acc;
          },
  ...
  toJSON(message: TabularData): unknown {
    ...
    if (message.columnTypes) {
      const entries = globalThis.Object.entries(message.columnTypes) as [string, TabularData_ColumnType][];
      if (entries.length > 0) {
        obj.columnTypes = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<TabularData>): TabularData {
    ...
    message.columnTypes = (globalThis.Object.entries(object.columnTypes ?? {}) as [string, TabularData_ColumnType][])
      .reduce((acc: { [key: string]: TabularData_ColumnType }, [key, value]: [string, TabularData_ColumnType]) => {
        if (value !== undefined) {
...
export const TabularData_ColumnTypesEntry: MessageFns<TabularData_ColumnTypesEntry> = {
  encode(message: TabularData_ColumnTypesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TabularData_ColumnTypesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Account: MessageFns<Account> = {
  encode(message: Account, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.paymentInfo !== undefined) {
      Struct.encode(Struct.wrap(message.paymentInfo), writer.uint32(34).fork()).join();
    }
    if (message.ownerId !== "") {
      writer.uint32(58).string(message.ownerId);
    }
    ...
    if (message.prepaidBalance !== undefined) {
      Money.encode(message.prepaidBalance, writer.uint32(106).fork()).join();
    }
    if (message.walletAddress !== "") {
  ...
  fromJSON(object: any): Account {
    return {
      ...
      paymentInfo: isObject(object.paymentInfo)
        ? object.paymentInfo
        : isObject(object.payment_info)
        ? object.payment_info
        : undefined,
      ownerId: isSet(object.ownerId) ? globalThis.String(object.ownerId) : "",
      owner: isSet(object.owner) ? Owner.fromJSON(object.owner) : undefined,
      ...
      paymentMethod: isSet(object.paymentMethod)
        ? payMethodFromJSON(object.paymentMethod)
        : isSet(object.payment_method)
        ? payMethodFromJSON(object.payment_method)
        : 0,
      usageOverCapLimit: isSet(object.usageOverCapLimit)
        ? globalThis.String(object.usageOverCapLimit)
        : isSet(object.usage_over_cap_limit)
        ? globalThis.String(object.usage_over_cap_limit)
        : "",
      status: isSet(object.status) ? globalThis.String(object.status) : "",
      prepaidBalance: isSet(object.prepaidBalance)
        ? Money.fromJSON(object.prepaidBalance)
        : isSet(object.prepaid_balance)
        ? Money.fromJSON(object.prepaid_balance)
        : undefined,
      walletAddress: isSet(object.walletAddress)
        ? globalThis.String(object.walletAddress)
        : isSet(object.wallet_address)
...
export const ImportedProject: MessageFns<ImportedProject> = {
  encode(message: ImportedProject, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    ...
    if (message.imported !== undefined) {
      Project.encode(message.imported, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ImportedProject {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectSuperset: MessageFns<ProjectSuperset> = {
  encode(message: ProjectSuperset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
    ...
    if (message.syncAt !== undefined) {
      Timestamp.encode(toTimestamp(message.syncAt), writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectSuperset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ProjectSuperset {
    return {
      ...
      createdAt: isSet(object.createdAt)
        ...
        ? fromJsonTimestamp(object.created_at)
        : undefined,
      syncAt: isSet(object.syncAt)
        ? fromJsonTimestamp(object.syncAt)
        : isSet(object.sync_at)
        ? fromJsonTimestamp(object.sync_at)
        : undefined,
    };
  },
...
export const SegmentParameter: MessageFns<SegmentParameter> = {
  encode(message: SegmentParameter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SegmentParameter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): SegmentParameter {
    return {
      cohortId: isSet(object.cohortId)
        ...
        : undefined,
      allUsers: isSet(object.allUsers)
        ? globalThis.Boolean(object.allUsers)
        : isSet(object.all_users)
        ? globalThis.Boolean(object.all_users)
        : undefined,
    };
  },
...
export const RetentionQuery: MessageFns<RetentionQuery> = {
  encode(message: RetentionQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.resources) {
      RetentionQuery_Resource.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.criteria !== 0) {
      writer.uint32(16).int32(message.criteria);
    }
    if (message.interval !== undefined) {
      RetentionQuery_Interval.encode(message.interval, writer.uint32(26).fork()).join();
    }
    if (message.selectorExpr !== undefined) {
      SelectorExpr.encode(message.selectorExpr, writer.uint32(34).fork()).join();
    }
    ...
    for (const v of message.segmentBy) {
      SegmentParameter.encode(v!, writer.uint32(50).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RetentionQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RetentionQuery {
    return {
      ...
      segmentBy: globalThis.Array.isArray(object?.segmentBy)
        ...
        : globalThis.Array.isArray(object?.segment_by)
        ? object.segment_by.map((e: any) => SegmentParameter.fromJSON(e))
        : [],
...
export const RetentionQuery_Filter: MessageFns<RetentionQuery_Filter> = {
  encode(message: RetentionQuery_Filter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.propertyFilter !== undefined) {
      SelectorExpr.encode(message.propertyFilter, writer.uint32(10).fork()).join();
    }
    if (message.timeFilter !== undefined) {
      RetentionQuery_Filter_TimeFilter.encode(message.timeFilter, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RetentionQuery_Filter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RetentionQuery_Filter {
    return {
      propertyFilter: isSet(object.propertyFilter)
        ? SelectorExpr.fromJSON(object.propertyFilter)
        : isSet(object.property_filter)
        ? SelectorExpr.fromJSON(object.property_filter)
        : undefined,
      timeFilter: isSet(object.timeFilter)
        ? RetentionQuery_Filter_TimeFilter.fromJSON(object.timeFilter)
        : isSet(object.time_filter)
        ? RetentionQuery_Filter_TimeFilter.fromJSON(object.time_filter)
        : undefined,
    };
  },
...
export const RetentionQuery_Filter_TimeFilter: MessageFns<RetentionQuery_Filter_TimeFilter> = {
  encode(message: RetentionQuery_Filter_TimeFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
      writer.uint32(8).int32(message.type);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RetentionQuery_Filter_TimeFilter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RetentionQuery_Resource: MessageFns<RetentionQuery_Resource> = {
  encode(message: RetentionQuery_Resource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.eventNames) {
      writer.uint32(10).string(v!);
    }
    if (message.filter !== undefined) {
      RetentionQuery_Filter.encode(message.filter, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RetentionQuery_Resource {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RetentionQuery_Interval: MessageFns<RetentionQuery_Interval> = {
  encode(message: RetentionQuery_Interval, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RetentionQuery_Interval {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RetentionMatrix: MessageFns<RetentionMatrix> = {
  encode(message: RetentionMatrix, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.samples) {
      RetentionMatrix_Sample.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RetentionMatrix {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RetentionMatrix_Sample: MessageFns<RetentionMatrix_Sample> = {
  encode(message: RetentionMatrix_Sample, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.time !== undefined) {
      Timestamp.encode(toTimestamp(message.time), writer.uint32(10).fork()).join();
    }
    if (message.segmentParameter !== undefined) {
      SegmentParameter.encode(message.segmentParameter, writer.uint32(18).fork()).join();
    }
    globalThis.Object.entries(message.labels).forEach(([key, value]: [string, string]) => {
      RetentionMatrix_Sample_LabelsEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RetentionMatrix_Sample {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RetentionMatrix_Sample {
    return {
      ...
      segmentParameter: isSet(object.segmentParameter)
        ? SegmentParameter.fromJSON(object.segmentParameter)
        : isSet(object.segment_parameter)
        ? SegmentParameter.fromJSON(object.segment_parameter)
        : undefined,
      labels: isObject(object.labels)
        ? (globalThis.Object.entries(object.labels) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
...
export const RetentionMatrix_Sample_LabelsEntry: MessageFns<RetentionMatrix_Sample_LabelsEntry> = {
  encode(message: RetentionMatrix_Sample_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RetentionMatrix_Sample_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ComputeStats: MessageFns<ComputeStats> = {
  encode(message: ComputeStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.computedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.computedAt), writer.uint32(10).fork()).join();
    }
    if (message.computeCostMs !== 0n) {
      ...
      writer.uint32(16).int64(message.computeCostMs);
    }
    if (message.binaryVersionHash !== 0n) {
      ...
      writer.uint32(24).uint64(message.binaryVersionHash);
    }
    ...
    if (message.clickhouseStats !== undefined) {
      ComputeStats_ClickhouseStats.encode(message.clickhouseStats, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ComputeStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.computeCostMs = reader.int64() as bigint;
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.binaryVersionHash = reader.uint64() as bigint;
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): ComputeStats {
    return {
      computedAt: isSet(object.computedAt)
        ...
        : undefined,
      computeCostMs: isSet(object.computeCostMs)
        ? BigInt(object.computeCostMs)
        : isSet(object.compute_cost_ms)
        ? BigInt(object.compute_cost_ms)
        : 0n,
      binaryVersionHash: isSet(object.binaryVersionHash)
        ? BigInt(object.binaryVersionHash)
        : isSet(object.binary_version_hash)
        ? BigInt(object.binary_version_hash)
        : 0n,
      computedBy: isSet(object.computedBy)
        ? globalThis.String(object.computedBy)
        : isSet(object.computed_by)
        ? globalThis.String(object.computed_by)
        : "",
      isCached: isSet(object.isCached)
        ? globalThis.Boolean(object.isCached)
        : isSet(object.is_cached)
        ? globalThis.Boolean(object.is_cached)
        : false,
      isRefreshing: isSet(object.isRefreshing)
        ? globalThis.Boolean(object.isRefreshing)
        : isSet(object.is_refreshing)
        ? globalThis.Boolean(object.is_refreshing)
        : false,
      clickhouseStats: isSet(object.clickhouseStats)
        ? ComputeStats_ClickhouseStats.fromJSON(object.clickhouseStats)
        : isSet(object.clickhouse_stats)
        ? ComputeStats_ClickhouseStats.fromJSON(object.clickhouse_stats)
        : undefined,
    };
  },
  ...
  fromPartial(object: DeepPartial<ComputeStats>): ComputeStats {
    ...
    message.computeCostMs = object.computeCostMs ?? 0n;
    message.binaryVersionHash = object.binaryVersionHash ?? 0n;
...
function createBaseComputeStats_ClickhouseStats(): ComputeStats_ClickhouseStats {
  return { readRows: 0n, readBytes: 0n, memoryUsage: 0n, queryDurationMs: 0n, resultRows: 0n, resultBytes: 0n };
}

export const ComputeStats_ClickhouseStats: MessageFns<ComputeStats_ClickhouseStats> = {
  encode(message: ComputeStats_ClickhouseStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.readRows !== 0n) {
      ...
      writer.uint32(8).uint64(message.readRows);
    }
    if (message.readBytes !== 0n) {
      ...
      writer.uint32(16).uint64(message.readBytes);
    }
    if (message.memoryUsage !== 0n) {
      ...
      writer.uint32(24).uint64(message.memoryUsage);
    }
    if (message.queryDurationMs !== 0n) {
      ...
      writer.uint32(32).uint64(message.queryDurationMs);
    }
    if (message.resultRows !== 0n) {
      ...
      writer.uint32(40).uint64(message.resultRows);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ComputeStats_ClickhouseStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.readRows = reader.uint64() as bigint;
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.readBytes = reader.uint64() as bigint;
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.memoryUsage = reader.uint64() as bigint;
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.queryDurationMs = reader.uint64() as bigint;
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.resultRows = reader.uint64() as bigint;
          continue;
        }
        case 6: {
          if (tag !== 48) {
  ...
  fromJSON(object: any): ComputeStats_ClickhouseStats {
    return {
      readRows: isSet(object.readRows)
        ? BigInt(object.readRows)
        : isSet(object.read_rows)
        ? BigInt(object.read_rows)
        : 0n,
      readBytes: isSet(object.readBytes)
        ? BigInt(object.readBytes)
        : isSet(object.read_bytes)
        ? BigInt(object.read_bytes)
        : 0n,
      memoryUsage: isSet(object.memoryUsage)
        ? BigInt(object.memoryUsage)
        : isSet(object.memory_usage)
        ? BigInt(object.memory_usage)
        : 0n,
      queryDurationMs: isSet(object.queryDurationMs)
        ? BigInt(object.queryDurationMs)
        : isSet(object.query_duration_ms)
        ? BigInt(object.query_duration_ms)
        : 0n,
      resultRows: isSet(object.resultRows)
        ? BigInt(object.resultRows)
        : isSet(object.result_rows)
        ? BigInt(object.result_rows)
        : 0n,
  ...
  fromPartial(object: DeepPartial<ComputeStats_ClickhouseStats>): ComputeStats_ClickhouseStats {
    const message = createBaseComputeStats_ClickhouseStats();
    message.readRows = object.readRows ?? 0n;
    message.readBytes = object.readBytes ?? 0n;
    message.memoryUsage = object.memoryUsage ?? 0n;
    message.queryDurationMs = object.queryDurationMs ?? 0n;
    message.resultRows = object.resultRows ?? 0n;
    message.resultBytes = object.resultBytes ?? 0n;
    return message;
  },
};
...
export const ClickhouseStatus: MessageFns<ClickhouseStatus> = {
  encode(message: ClickhouseStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.mutations).forEach(([key, value]: [string, ClickhouseStatus_Mutation]) => {
      ClickhouseStatus_MutationsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    globalThis.Object.entries(message.processes).forEach(([key, value]: [string, ClickhouseStatus_Processes]) => {
      ClickhouseStatus_ProcessesEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClickhouseStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ClickhouseStatus {
    return {
      mutations: isObject(object.mutations)
        ? (globalThis.Object.entries(object.mutations) as [string, any][]).reduce(
          (acc: { [key: number]: ClickhouseStatus_Mutation }, [key, value]: [string, any]) => {
      ...
      processes: isObject(object.processes)
        ? (globalThis.Object.entries(object.processes) as [string, any][]).reduce(
          (acc: { [key: number]: ClickhouseStatus_Processes }, [key, value]: [string, any]) => {
  ...
  toJSON(message: ClickhouseStatus): unknown {
    ...
    if (message.mutations) {
      const entries = globalThis.Object.entries(message.mutations) as [string, ClickhouseStatus_Mutation][];
      if (entries.length > 0) {
        obj.mutations = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.processes) {
      const entries = globalThis.Object.entries(message.processes) as [string, ClickhouseStatus_Processes][];
      if (entries.length > 0) {
        obj.processes = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<ClickhouseStatus>): ClickhouseStatus {
    const message = createBaseClickhouseStatus();
    message.mutations = (globalThis.Object.entries(object.mutations ?? {}) as [string, ClickhouseStatus_Mutation][])
      .reduce(
        (acc: { [key: number]: ClickhouseStatus_Mutation }, [key, value]: [string, ClickhouseStatus_Mutation]) => {
          if (value !== undefined) {
    ...
    message.processes = (globalThis.Object.entries(object.processes ?? {}) as [string, ClickhouseStatus_Processes][])
      .reduce(
        (acc: { [key: number]: ClickhouseStatus_Processes }, [key, value]: [string, ClickhouseStatus_Processes]) => {
          if (value !== undefined) {
...
export const ClickhouseStatus_Mutation: MessageFns<ClickhouseStatus_Mutation> = {
  encode(message: ClickhouseStatus_Mutation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ClickhouseStatus_Mutation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ClickhouseStatus_Mutation {
    return {
      undoneCnt: isSet(object.undoneCnt)
        ? globalThis.Number(object.undoneCnt)
        : isSet(object.undone_cnt)
        ? globalThis.Number(object.undone_cnt)
        : 0,
    };
  },
...
export const ClickhouseStatus_Process: MessageFns<ClickhouseStatus_Process> = {
  encode(message: ClickhouseStatus_Process, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== "") {
      writer.uint32(10).string(message.query);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ClickhouseStatus_Process {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ClickhouseStatus_Process {
    return {
      query: isSet(object.query) ? globalThis.String(object.query) : "",
      queryKind: isSet(object.queryKind)
        ? globalThis.String(object.queryKind)
        : isSet(object.query_kind)
        ? globalThis.String(object.query_kind)
        : "",
...
export const ClickhouseStatus_Processes: MessageFns<ClickhouseStatus_Processes> = {
  encode(message: ClickhouseStatus_Processes, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.processes) {
      ClickhouseStatus_Process.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClickhouseStatus_Processes {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ClickhouseStatus_MutationsEntry: MessageFns<ClickhouseStatus_MutationsEntry> = {
  encode(message: ClickhouseStatus_MutationsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== 0) {
      writer.uint32(8).int32(message.key);
    }
    if (message.value !== undefined) {
      ClickhouseStatus_Mutation.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClickhouseStatus_MutationsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ClickhouseStatus_ProcessesEntry: MessageFns<ClickhouseStatus_ProcessesEntry> = {
  encode(message: ClickhouseStatus_ProcessesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== 0) {
      writer.uint32(8).int32(message.key);
    }
    if (message.value !== undefined) {
      ClickhouseStatus_Processes.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClickhouseStatus_ProcessesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectVariables: MessageFns<ProjectVariables> = {
  encode(message: ProjectVariables, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
      writer.uint32(10).string(message.projectId);
    }
    for (const v of message.variables) {
      ProjectVariables_Variable.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ProjectVariables {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectVariables_Variable: MessageFns<ProjectVariables_Variable> = {
  encode(message: ProjectVariables_Variable, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectVariables_Variable {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CachePolicy: MessageFns<CachePolicy> = {
  encode(message: CachePolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CachePolicy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CachePolicy {
    return {
      cacheTtlSecs: isSet(object.cacheTtlSecs)
        ? globalThis.Number(object.cacheTtlSecs)
        : isSet(object.cache_ttl_secs)
        ? globalThis.Number(object.cache_ttl_secs)
        : 0,
      cacheRefreshTtlSecs: isSet(object.cacheRefreshTtlSecs)
        ? globalThis.Number(object.cacheRefreshTtlSecs)
        : isSet(object.cache_refresh_ttl_secs)
        ? globalThis.Number(object.cache_refresh_ttl_secs)
        : 0,
      forceRefresh: isSet(object.forceRefresh)
        ...
        : false,
      noCache: isSet(object.noCache)
        ? globalThis.Boolean(object.noCache)
        : isSet(object.no_cache)
        ? globalThis.Boolean(object.no_cache)
        : false,
    };
  },
...
export const Notification: MessageFns<Notification> = {
  encode(message: Notification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.owner !== undefined) {
      Owner.encode(message.owner, writer.uint32(82).fork()).join();
    }
    if (message.project !== undefined) {
      Project.encode(message.project, writer.uint32(90).fork()).join();
    }
    globalThis.Object.entries(message.attributes).forEach(([key, value]: [string, string]) => {
      Notification_AttributesEntry.encode({ key: key as any, value }, writer.uint32(98).fork()).join();
    });
...
export const Notification_AttributesEntry: MessageFns<Notification_AttributesEntry> = {
  encode(message: Notification_AttributesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Notification_AttributesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RichValue: MessageFns<RichValue> = {
  encode(message: RichValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.int64Value !== undefined) {
      ...
      writer.uint32(104).int64(message.int64Value);
    }
    ...
    if (message.timestampValue !== undefined) {
      Timestamp.encode(toTimestamp(message.timestampValue), writer.uint32(58).fork()).join();
    }
    if (message.bigintValue !== undefined) {
      BigInteger.encode(message.bigintValue, writer.uint32(66).fork()).join();
    }
    if (message.bigdecimalValue !== undefined) {
      BigDecimal.encode(message.bigdecimalValue, writer.uint32(74).fork()).join();
    }
    if (message.listValue !== undefined) {
      RichValueList.encode(message.listValue, writer.uint32(82).fork()).join();
    }
    if (message.structValue !== undefined) {
      RichStruct.encode(message.structValue, writer.uint32(90).fork()).join();
    }
    if (message.tokenValue !== undefined) {
      TokenAmount.encode(message.tokenValue, writer.uint32(98).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RichValue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.int64Value = reader.int64() as bigint;
          continue;
        }
        case 3: {
          if (tag !== 25) {
  ...
  fromJSON(object: any): RichValue {
    return {
      nullValue: isSet(object.nullValue)
        ...
        ? richValue_NullValueFromJSON(object.null_value)
        : undefined,
      intValue: isSet(object.intValue)
        ? globalThis.Number(object.intValue)
        : isSet(object.int_value)
      ...
      int64Value: isSet(object.int64Value)
        ? BigInt(object.int64Value)
        : isSet(object.int64_value)
        ? BigInt(object.int64_value)
        : undefined,
      ...
      timestampValue: isSet(object.timestampValue)
        ...
        : undefined,
      bigintValue: isSet(object.bigintValue)
        ? BigInteger.fromJSON(object.bigintValue)
        : isSet(object.bigint_value)
        ? BigInteger.fromJSON(object.bigint_value)
        : undefined,
      bigdecimalValue: isSet(object.bigdecimalValue)
        ? BigDecimal.fromJSON(object.bigdecimalValue)
        : isSet(object.bigdecimal_value)
        ? BigDecimal.fromJSON(object.bigdecimal_value)
        : undefined,
      listValue: isSet(object.listValue)
        ? RichValueList.fromJSON(object.listValue)
        : isSet(object.list_value)
        ? RichValueList.fromJSON(object.list_value)
        : undefined,
      structValue: isSet(object.structValue)
        ? RichStruct.fromJSON(object.structValue)
        : isSet(object.struct_value)
        ? RichStruct.fromJSON(object.struct_value)
        : undefined,
      tokenValue: isSet(object.tokenValue)
        ? TokenAmount.fromJSON(object.tokenValue)
        : isSet(object.token_value)
...
export const RichStruct: MessageFns<RichStruct> = {
  encode(message: RichStruct, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.fields).forEach(([key, value]: [string, RichValue]) => {
      RichStruct_FieldsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RichStruct {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    return {
      fields: isObject(object.fields)
        ? (globalThis.Object.entries(object.fields) as [string, any][]).reduce(
          (acc: { [key: string]: RichValue }, [key, value]: [string, any]) => {
  ...
  toJSON(message: RichStruct): unknown {
    const obj: any = {};
    if (message.fields) {
      const entries = globalThis.Object.entries(message.fields) as [string, RichValue][];
      if (entries.length > 0) {
        obj.fields = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<RichStruct>): RichStruct {
    const message = createBaseRichStruct();
    message.fields = (globalThis.Object.entries(object.fields ?? {}) as [string, RichValue][]).reduce(
      (acc: { [key: string]: RichValue }, [key, value]: [string, RichValue]) => {
        if (value !== undefined) {
...
export const RichStruct_FieldsEntry: MessageFns<RichStruct_FieldsEntry> = {
  encode(message: RichStruct_FieldsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      RichValue.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RichStruct_FieldsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RichValueList: MessageFns<RichValueList> = {
  encode(message: RichValueList, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.values) {
      RichValue.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RichValueList {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RichStructList: MessageFns<RichStructList> = {
  encode(message: RichStructList, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.entities) {
      RichStruct.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RichStructList {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BigDecimal: MessageFns<BigDecimal> = {
  encode(message: BigDecimal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== undefined) {
      BigInteger.encode(message.value, writer.uint32(10).fork()).join();
    }
    if (message.exp !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BigDecimal {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const TokenAmount: MessageFns<TokenAmount> = {
  encode(message: TokenAmount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.token !== undefined) {
      CoinID.encode(message.token, writer.uint32(10).fork()).join();
    }
    if (message.amount !== undefined) {
      BigDecimal.encode(message.amount, writer.uint32(18).fork()).join();
    }
    if (message.specifiedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.specifiedAt), writer.uint32(26).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): TokenAmount {
    return {
      ...
      specifiedAt: isSet(object.specifiedAt)
        ? fromJsonTimestamp(object.specifiedAt)
        : isSet(object.specified_at)
        ? fromJsonTimestamp(object.specified_at)
        : undefined,
    };
  },
...
export const RequestLog: MessageFns<RequestLog> = {
  encode(message: RequestLog, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.requestHeader !== undefined) {
      Struct.encode(Struct.wrap(message.requestHeader), writer.uint32(66).fork()).join();
    }
    if (message.responseBody.length !== 0) {
      writer.uint32(74).bytes(message.responseBody);
    }
    if (message.responseHeader !== undefined) {
      Struct.encode(Struct.wrap(message.responseHeader), writer.uint32(82).fork()).join();
    }
    if (message.createdAt !== undefined) {
    ...
    if (message.duration !== 0n) {
      ...
      writer.uint32(96).uint64(message.duration);
    }
    if (message.queryDuration !== 0n) {
      ...
      writer.uint32(104).uint64(message.queryDuration);
    }
    if (message.method !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          ...
          message.duration = reader.uint64() as bigint;
          continue;
        }
        case 13: {
          if (tag !== 104) {
          ...
          message.queryDuration = reader.uint64() as bigint;
          continue;
        }
        case 14: {
          if (tag !== 114) {
  ...
  fromJSON(object: any): RequestLog {
    return {
      ...
      requestBody: isSet(object.requestBody)
        ? bytesFromBase64(object.requestBody)
        : isSet(object.request_body)
        ? bytesFromBase64(object.request_body)
        : new Uint8Array(0),
      requestHeader: isObject(object.requestHeader)
        ? object.requestHeader
        : isObject(object.request_header)
        ? object.request_header
        : undefined,
      responseBody: isSet(object.responseBody)
        ? bytesFromBase64(object.responseBody)
        : isSet(object.response_body)
        ? bytesFromBase64(object.response_body)
        : new Uint8Array(0),
      responseHeader: isObject(object.responseHeader)
        ? object.responseHeader
        : isObject(object.response_header)
      ...
      queryDuration: isSet(object.queryDuration)
        ? BigInt(object.queryDuration)
        : isSet(object.query_duration)
        ? BigInt(object.query_duration)
        : 0n,
      method: isSet(object.method) ? globalThis.String(object.method) : "",
      rpcNodeId: isSet(object.rpcNodeId)
        ? globalThis.String(object.rpcNodeId)
        : isSet(object.rpc_node_id)
        ? globalThis.String(object.rpc_node_id)
        : "",
      originUrl: isSet(object.originUrl)
        ? globalThis.String(object.originUrl)
        : isSet(object.origin_url)
        ? globalThis.String(object.origin_url)
        : "",
      endpointType: isSet(object.endpointType)
  ...
  fromPartial(object: DeepPartial<RequestLog>): RequestLog {
    ...
    message.queryDuration = object.queryDuration ?? 0n;
...
export const HistoryChat: MessageFns<HistoryChat> = {
  encode(message: HistoryChat, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.messages !== undefined) {
      ListValue.encode(ListValue.wrap(message.messages), writer.uint32(34).fork()).join();
    }
    if (message.type !== 0) {
  ...
  fromJSON(object: any): HistoryChat {
    return {
      ...
      updatedAt: isSet(object.updatedAt)
        ...
        ? fromJsonTimestamp(object.updated_at)
        : undefined,
      projectOwner: isSet(object.projectOwner)
        ? globalThis.String(object.projectOwner)
        : isSet(object.project_owner)
        ? globalThis.String(object.project_owner)
        : undefined,
...
export const ProjectOwnerAndSlug: MessageFns<ProjectOwnerAndSlug> = {
  encode(message: ProjectOwnerAndSlug, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ownerName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectOwnerAndSlug {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
